  ...
  return (
    <>
        <div className="px-[1rem] mt-[3rem] md:px-[3rem] md:mt-[12rem] max-md:flex flex-col items-center">
            <div className="flex flx items-center md:justify-between">
            ...
            <div className="md:px-[3rem] my-[3rem] flex flx items-center gapp md:justify-between ">
            ...
            <div className=" ic  lg:p-[5rem] Home-shad1 Home-bod1 w-[251.68px] md:w-[93%] 2xl:w-[93%] lg:h-[587px] 2xl:h-[667px] bg-white flex flx">
        ...
        <div className="my-[4rem]  md:my-[7rem] w-full flex flex-col items-center text-center">
            ...
            <div className="md:border-t-[1px] border-t-gray-300 md:mt-[3rem] md:w-[70%] flex justify-center maxtop">
                <img src={LuminarLifespan} alt="" className='w-[322px] h-[280px] lg:w-[575px] lg:h-[500px] md:w-[80%] ' />
            </div>

            <div className="flex flx gapp items-center md:justify-between w-full px-[1rem] md:px-[5rem] my-[3rem]">
                ...
                <img src={CircleCut} alt="" className='w-[80%]  2xl:w-full 2xl:h-[90%] maxtop1' />
        ...
        <div className="flex flx ic1 justify-between   lg:px-[5rem]">
